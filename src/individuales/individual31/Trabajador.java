...
//Clase trabajador - Cintia Muñoz Valdés
public class Trabajador {
    ...
    private int edad;
    private CargaFamiliar carga; //Agrego el atributo carga de la clae CargaFamiliar
    ...
    public Trabajador(String nombre, String apellido1, String apellido2, String run, String telefono, int edad, CargaFamiliar carga) {
        this.nombre = nombre;
    ...
    public void mostrarDatos(){
        System.out.println("El teléfono del trabajador es: " +getTelefono() + "y su edad es: " +getEdad() );
    }
}
