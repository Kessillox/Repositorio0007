                    ...
                    case 1:
                        do {
                            ...
                            while (nombreUser.length() < 3 || nombreUser.length() > 20) {
                                System.out.println("su nombre debe ser mayor a 3 y menor a 20 caracteres");
                                nombreUser = sc.nextLine();
                            }

                            System.out.println("favor ingrese su primer apellido");
                            apellido1User = sc.nextLine();
                            while (apellido1User.length() < 3 || apellido1User.length() > 20) {
                                System.out.println("su apellido debe ser mayor a 3 y menor a 20 caracteres");
                                apellido1User = sc.nextLine();
                            }


                            System.out.println("favor ingrese su segundo apellido");
                        ...
                        contenedorP.mostrarUsuarios(cliente);
                        break;
                    case 3:
