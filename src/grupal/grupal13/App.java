...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        user.setFechaDeNacimiento("6 de marzo 2000");// del objeto user se utiliza el metodo modificador setFechaDeNacimiento y se le pasa el parametro
